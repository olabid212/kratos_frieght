    ...
    <div>
      ...
      <div className='bg-[#091242]  min-h-[70vh] flex-[50%] relative'>
        ...
        <div className='w-full relative'>
         ...
         <img className=' absolute lg:top-[120px]  xl:-right-[100px] ' src="/Image.jpg" alt="" />
      ...
      <div className='space-y-5 '>
        <p className='p-2 text-[14px] font-[400] bg-gray-100 w-fit border-l-2 border-[#FFB629]'>Why Choose</p>
        <h1 className='text-[#1C1F35] font-[600] text-[35px] leading-[41px]'>We create opportunity to reach potential
        </h1>
