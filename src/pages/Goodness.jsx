  ...
  return (
    ...
    <div>
      ...
      <div className='space-y-2'>
        <h1 className='text-[#1C1F35] font-[500] text-[25px] leading-[29px] '>Warehousing Services</h1>
        <p className='font-[500] text-[16px] leading-[24px]'>Leverage agile frameworks to provide a robust synopsis for strategy foster collaborative thinking </p>
      </div>
      </div>
      ...
      <div className='space-y-2'>
        <h1 className='text-[#1C1F35] font-[500] text-[25px] leading-[29px]'>Safety & Quality</h1>
        <p className='font-[500] text-[16px] leading-[24px]'>Leverage agile frameworks to provide a robust synopsis for strategy foster collaborative thinking </p>
      </div>
      </div>
      ...
      <div className='space-y-2'>
        <h1 className='text-[#1C1F35] font-[500] text-[25px] leading-[29px]'>Care For Environment</h1>
        <p className='font-[500] text-[16px] leading-[24px]'>Leverage agile frameworks to provide a robust synopsis for strategy foster collaborative thinking </p>
      </div>
      </div>
