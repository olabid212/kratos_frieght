      ...
      <div className="px-5 xl:px-40 w-full py-10 bg-[#091242] overflow-hidden">
        <footer className=" flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-[70%] px-4 flex justify-between gap-10 flex-col md:flex-row" >
            ...
            <div>
              <h1 className="mb-[40px] font-[500] text-[#ffffff] text-[25px]">
                Utility
              </h1>
              ...
              <ul className="space-y-4">
                <li>
                  <Link
                    className="font-[500] text-[#ffffff] text-[16px]"
                    to="/"
                  >
                    Style Guide
                  </Link>
            ...
            <div>
              <h1 className="mb-[40px] font-[500] text-[#fff] text-[25px]">
                Subscribe
              </h1>
              <form>
                <input
        ...
        <div className="text-center">
          <p className="text-white mt-7 ">
            {" "}
            Copyright © TransitFlow | Designed by Oatship Systems
          </p>
        </div>
      </div>
    </div>
